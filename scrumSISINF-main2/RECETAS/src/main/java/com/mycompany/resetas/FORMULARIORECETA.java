...
public class FORMULARIORECETA extends javax.swing.JFrame {
    ...
    public FORMULARIORECETA() {
        ...
        //objetoconeccion.establecerConeccion();
        CRecetas objetoReceta = new CRecetas();
        objetoReceta.mostrarRecetas(tablarecetas);
    }
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtCosto, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        CRecetas objetoReceta = new CRecetas();
        objetoReceta.insertarReceta(txtReceta, txtCosto);
        objetoReceta.mostrarRecetas(tablarecetas);
